    ...
    <div class="col-sm-10">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="{{ $name['main'] }}_main">
                {{ Form::textarea($name['main'], $value['main'],
                    ...
                    ], isset($attributes['main']) ? $attributes['main'] : [])
                ) }}
            </div>
            @foreach ($languages as $language)
                <div role="tabpanel" class="tab-pane" id="{{ $name['main'] }}_{{ $language->id }}">
                    {{ Form::textarea($name['lang'].'['.$language->id.']', $model->getLocalizationField($name['main'], $language->id),
                        array_merge(['class' => 'form-control',
                        ...
                        ], isset($attributes['lang']) ? $attributes['lang'] : [])
                    ) }}
                </div>
            @endforeach
        </div>
