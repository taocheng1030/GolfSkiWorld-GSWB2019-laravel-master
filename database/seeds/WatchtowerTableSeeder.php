...
class WatchtowerTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $roles = [
            ...
            [
                'name'          => 'Administrators, Golf',
                'slug'          => 'admingolf',
                'description'   => 'Golf admin area access',
                'special'       => null,
            ],

            [
                'name'          => 'Administrators, Ski',
                'slug'          => 'adminski',
                'description'   => 'Ski admin area access',
                'special'       => null,
            ],
        ];
        ...
        */
        ...
        DB::table('role_user')->insert( ['role_id' => 4, 'user_id'=> 4] );
        DB::table('role_user')->insert( ['role_id' => 5, 'user_id'=> 6] );
        DB::table('role_user')->insert( ['role_id' => 6, 'user_id'=> 7] );
